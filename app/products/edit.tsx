...
import { editProductSchema, EditProductFormData } from '@/utils/validation';
...
export default function EditProductScreen() {
  ...
  const { control, handleSubmit, formState: { errors }, reset } = useForm<EditProductFormData>({
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      reset({
        ...
        quantityPercent: foundProduct.quantityPercent,
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.button} onTouchEnd={handleSubmit(onSubmit)}>
        <ThemedText type="defaultSemiBold">Update Product</ThemedText>
      </View>
    </ThemedView>
  );
}
